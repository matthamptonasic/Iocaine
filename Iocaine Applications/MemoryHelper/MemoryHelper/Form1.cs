                ...
                while (true)
                {
                    ...
                    switch (GetOffsetCBIndex())
                    {
                        ...
                        case (int)OFFSET.EQUIP_TABLE:
                            ...
                            AppendText("\nEq ID Main: " + MemReads.Self.Equipment.get_main_id());
                            AppendText("\nEqp'd Sub: " + MemReads.Self.Equipment.get_sub_equipped());
                            AppendText("\nEq ID Sub: " + MemReads.Self.Equipment.get_sub_id());
                            AppendText("\nEqp'd Range: " + MemReads.Self.Equipment.get_range_equipped());
                            AppendText("\nEq ID Range: " + MemReads.Self.Equipment.get_range_id());
                            AppendText("\nEqp'd Ammo: " + MemReads.Self.Equipment.get_ammo_equipped());
                            AppendText("\nEq ID Ammo: " + MemReads.Self.Equipment.get_ammo_id());
                            AppendText("\nEq Qn Ammo: " + MemReads.Self.Equipment.get_ammo_quan());
                            AppendText("\nEqp'd Head: " + MemReads.Self.Equipment.get_head_equipped());
                            AppendText("\nEq ID Head: " + MemReads.Self.Equipment.get_head_id());
                            AppendText("\nEqp'd Neck: " + MemReads.Self.Equipment.get_neck_equipped());
                            AppendText("\nEq ID Neck: " + MemReads.Self.Equipment.get_neck_id());
                            AppendText("\nEqp'd EarL: " + MemReads.Self.Equipment.get_earL_equipped());
                            AppendText("\nEq ID EarL: " + MemReads.Self.Equipment.get_earL_id());
                            AppendText("\nEqp'd EarR: " + MemReads.Self.Equipment.get_earR_equipped());
                            AppendText("\nEq ID EarR: " + MemReads.Self.Equipment.get_earR_id());
                            AppendText("\nEqp'd Body: " + MemReads.Self.Equipment.get_body_equipped());
                            AppendText("\nEq ID Body: " + MemReads.Self.Equipment.get_body_id());
                            AppendText("\nEqp'd Hands: " + MemReads.Self.Equipment.get_hands_equipped());
                            AppendText("\nEq ID Hands: " + MemReads.Self.Equipment.get_hands_id());
                            AppendText("\nEqp'd RingL: " + MemReads.Self.Equipment.get_ringL_equipped());
                            AppendText("\nEq ID RingL: " + MemReads.Self.Equipment.get_ringL_id());
                            AppendText("\nEqp'd RingR: " + MemReads.Self.Equipment.get_ringR_equipped());
                            AppendText("\nEq ID RingR: " + MemReads.Self.Equipment.get_ringR_id());
                            AppendText("\nEqp'd Back: " + MemReads.Self.Equipment.get_back_equipped());
                            AppendText("\nEq ID Back: " + MemReads.Self.Equipment.get_back_id());
                            AppendText("\nEqp'd Waist: " + MemReads.Self.Equipment.get_waist_equipped());
                            AppendText("\nEq ID Waist: " + MemReads.Self.Equipment.get_waist_id());
                            AppendText("\nEqp'd Legs: " + MemReads.Self.Equipment.get_legs_equipped());
                            AppendText("\nEq ID Legs: " + MemReads.Self.Equipment.get_legs_id());
                            AppendText("\nEqp'd Feet: " + MemReads.Self.Equipment.get_feet_equipped());
                            AppendText("\nEq ID Feet: " + MemReads.Self.Equipment.get_feet_id());
                            break;
